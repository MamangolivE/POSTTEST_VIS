Public Class Form1
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        ErrorProvider1.Clear()
        If Not ValidasiJenisBuku(ErrorProvider1, txtKodeJenis, txtJenis) Then
            Exit Sub
        End If

        Dim kode As String = txtKodeJenis.Text.Trim()
        Dim namaJenis As String = txtJenis.Text.Trim()
        If KodeSudahAda(kode) Then MessageBox.Show("Kode Jenis sudah terdaftar", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
